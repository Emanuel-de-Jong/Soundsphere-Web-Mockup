        ...
        <div class="main-box">
            ...
            <section id="form-section">
                <form class="form-settings" action="?a=players_player1_index" method="post">
                    <label id="username-preview" title="A preview that shows how your username will look">Player1</label>
                    ...
                    <div class="form-item">
                        <label for="banner" class="form-label form-optional" title="The uploaded image will be blurred and shown behind your profile page">Blurred banner image</label>
                        <input type="file" class="form-control input-image" name="banner" id="banner" accept=".png, .jpg, .jpeg">
                    </div>

                    <div class="form-item">
                        <label class="form-label form-optional w-100" title="The input modes on your profile and next to you in tables">
